...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Creativewl_Currency' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Dowell_CustomToolbar' => 1,
        'Dowell_Forsage' => 1,
        'Dowell_NewProducts' => 1,
        'Dowell_OrdersSuppliers' => 1,
