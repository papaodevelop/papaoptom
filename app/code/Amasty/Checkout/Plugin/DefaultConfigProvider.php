...
class DefaultConfigProvider
{
    ...
    /**
     * Initialize shipping address (select default and save) before default config generation.
     */
    ...
    public function afterGetConfig(\Magento\Checkout\Model\DefaultConfigProvider $subject, $config)
    {
        ...
        $config['quoteData']['initPaymentMethods'] =
            $this->checkoutInitialization->getPaymentMethods((int)$quote->getId());
