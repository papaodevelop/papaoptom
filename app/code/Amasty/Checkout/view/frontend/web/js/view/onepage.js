    ...
    function (
        ...
        return Component.extend({
            ...
            initializePaymentStep: function (component) {
                ...
                quote.setTotals(window.checkoutConfig.quoteData.initPaymentMethods.totals);

                paymentService.setPaymentMethods(
                    paymentMethodConverter(window.checkoutConfig.quoteData.initPaymentMethods.payment_methods)
                );
