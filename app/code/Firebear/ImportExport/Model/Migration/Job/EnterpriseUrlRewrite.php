    ...
    public function job($output, $additionalOptions = null)
    {
        ...
        $sourceSelect = $source->select()
            ->from('enterprise_url_rewrite', [
                ...
                ['s' => 'enterprise_url_rewrite_redirect_rewrite'],
                'enterprise_url_rewrite.url_rewrite_id = s.url_rewrite_id',
                []
            )->join(
                ['b' => 'enterprise_url_rewrite_redirect'],
            ...
            ->where('enterprise_url_rewrite.is_system = ?', 0);

        $this->storeIdFilter->apply('enterprise_url_rewrite.store_id', $sourceSelect);
